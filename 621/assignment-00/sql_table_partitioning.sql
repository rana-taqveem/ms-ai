    ...
    alter database mlops_db add file (
        ...
        filename = '/var/opt/mssql/data/v1/mlops_db_t1_fg1_f1.ndf',
        size = 5MB,
        filegrowth = 5MB
        ),
        (
        name = 'mlops_db_t1_fg1_file2',
        filename = '/var/opt/mssql/data/v1/mlops_db_t1_fg1_f2.ndf',
        size = 5MB,
        filegrowth = 5MB
        ) To filegroup t1_fg1
    ...
    alter database mlops_db add file (
        ...
        filename = '/var/opt/mssql/data/v2/mlops_db_t1_fg2_f1.ndf',
        size = 5MB,
        filegrowth = 5MB
        ),
        (
        name = 'mlops_db_t1_fg2_file2',
        filename = '/var/opt/mssql/data/v2/mlops_db_t1_fg2_f2.ndf',
        size = 5MB,
        filegrowth = 5MB
        ),
        (
        name = 'mlops_db_t1_fg2_file3',
        filename = '/var/opt/mssql/data/v2/mlops_db_t1_fg2_f3.ndf',
        size = 5MB,
        filegrowth = 5MB
        ) To filegroup t1_fg2
    ...
    alter database mlops_db add file (
        ...
        filename = '/var/opt/mssql/data/v1/mlops_db_t2_fg1_f1.ndf',
        size = 5MB,
        filegrowth = 5MB
        ),
        (
        name = 'mlops_db_t2_fg1_file2',
        filename = '/var/opt/mssql/data/v1/mlops_db_t2_fg1_f2.ndf',
        size = 5MB,
        filegrowth = 5MB
        ) To filegroup t2_fg1
    ...
    alter database mlops_db add file (
        ...
        filename = '/var/opt/mssql/data/v3/mlops_db_t2_fg2_f1.ndf',
        size = 5MB,
        filegrowth = 5MB
        ),
        (
        name = 'mlops_db_t2_fg2_file2',
        filename = '/var/opt/mssql/data/v3/mlops_db_t2_fg2_f2.ndf',
        size = 5MB,
        filegrowth = 5MB
        ) To filegroup t2_fg2
    ...
    alter database mlops_db add file (
        ...
        filename = '/var/opt/mssql/data/v4/mlops_db_t2_fg3_f1.ndf',
        size = 5MB,
        filegrowth = 5MB
        ),
        (
        name = 'mlops_db_t2_fg3_file2',
        filename = '/var/opt/mssql/data/v4/mlops_db_t2_fg3_f2.ndf',
        size = 5MB,
        filegrowth = 5MB
        ),
        (
        name = 'mlops_db_t2_fg3_file3',
        filename = '/var/opt/mssql/data/v4/mlops_db_t2_fg3_f3.ndf',
        size = 5MB,
        filegrowth = 5MB
        ),
        (
        name = 'mlops_db_t2_fg3_file4',
        filename = '/var/opt/mssql/data/v4/mlops_db_t2_fg3_f4.ndf',
        size = 5MB,
        filegrowth = 5MB
        ) To filegroup t2_fg3
